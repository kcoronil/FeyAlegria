...
class UsuariosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('inicialBundle:Usuarios')->findAll();

        return $this->render('inicialBundle:Usuarios:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('inicialBundle:Usuarios:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('inicialBundle:Usuarios')->find($id);
        ...
        return $this->render('inicialBundle:Usuarios:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('inicialBundle:Usuarios:edit.html.twig', array(
            'entity'      => $entity,
