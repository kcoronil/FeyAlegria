...
class PeriodoEscolarAlumnoType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Test\inicialBundle\Entity\PeriodoEscolarAlumno'
        ));
    }
    ...
    {
        return 'test_inicialbundle_periodoescolaralumno';
    }
}
